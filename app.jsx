  ...
  return (
    <React.Fragment>
      ...
      <div className="app">
        ...
        <SectionHead num="00" title="BATTLE ARENA" sub="token-metered turns · hot-seat or cpu" />
        ...
        <SectionHead num="02" title="FATALITIES" sub="hidden weapons · source-backed finishers" />
        <FatalitiesPanel contenders={contenders} />

        {/* ROSTER */}
        <SectionHead num="03" title="FIGHTER ROSTER" sub="select a character — read the dossier" />
        ...
        {/* INTEL FEED */}
        <SectionHead num="04" title="INTEL FEED" sub="key-person posts · auto-tagged for strategy" />
        <IntelFeed tweets={tweets} filter={intelFilter} setFilter={setIntelFilter} />

        {/* ANNOUNCEMENTS */}
        <SectionHead num="05" title="POWER MOVES" sub="releases · hires · partnerships · funding" />
        <AnnouncementTimeline rows={announcements} />

        {/* VERTICALS */}
        <SectionHead num="06" title="VERTICAL CONQUEST" sub="who owns which industry · today" />
